...
<body>
    ...
    <header>
        <div class="inner">
            ...
            <ul id="gnb">
                ...
                <li><a href="${pageContext.request.contextPath}/">자료실</a></li>
            </ul>
            ...
            <ul class="util">
                ...
                <c:if test="${userLoggedIn}">
					<li><a href="${pageContext.request.contextPath}/infoform">${customInfo.name}님</a></li>
    ...
    <figure>
        <video src="${pageContext.request.contextPath}/08/img/visual.mp4" autoplay muted loop></video>
        <div class="inner">
            <h1>INNOVATION</h1>
    ...
    <section>
        <div class="inner">
            ...
            <div class="wrap">
                <article>
                    <div class="pic">
                        <img src="${pageContext.request.contextPath}/08/img/news1.jpg" alt="1번째 콘텐츠 이미지">
                    </div>
                ...
                <article>
                    <div class="pic">
                        <img src="${pageContext.request.contextPath}/08/img/news2.jpg" alt="2번째 콘텐츠 이미지">
                    </div>
                    <h2><a href="#">Lorem ipsum dolor sit.</a></h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae minus, eaque corrupti vero ad
                        maiores!</p>
                ...
                <article>
                    <div class="pic">
                        <img src="${pageContext.request.contextPath}/08/img/news3.jpg" alt="3번째 콘텐츠 이미지">
                    </div>
                    <h2><a href="#">Lorem ipsum dolor sit.</a></h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae minus, eaque corrupti vero ad
                        maiores!</p>
                ...
                <article>
                    <div class="pic">
                        <img src="${pageContext.request.contextPath}/08/img/news4.jpg" alt="4번째 콘텐츠 이미지">
                    </div>
                    <h2><a href="#">Lorem ipsum dolor sit.</a></h2>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Vitae minus, eaque corrupti vero ad
                        maiores!</p>
